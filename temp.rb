Producto.create!(titulo: 'Rails, Angular, Postgres, and Bootstrap',
  descripcion:
    %{Powerful, Effective, and Efficient Full-Stack Web Development
      ...
      environment.},
  imagen_url: 'dcbang.jpg',
  precio: 45.00)
# . . .
Producto.create!(titulo: 'Seven Mobile Apps in Seven Weeks',
  descripcion:
    %{
  ...
  imagen_url: '7apps.jpg',
  precio: 26.00)
# . . .

Producto.create!(titulo: 'Ruby Performance Optimization',
  descripcion:
    %{
